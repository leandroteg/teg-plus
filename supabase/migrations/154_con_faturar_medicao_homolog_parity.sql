-- 154_con_faturar_medicao_homolog_parity.sql
-- Replica a RPC con_faturar_medicao em homolog (em prod ja existe; CREATE OR REPLACE eh idempotente).
-- Envia uma medicao aprovada ao Financeiro: cria CP (despesa) ou CR (receita) previsto e marca medicao como 'faturado'.
