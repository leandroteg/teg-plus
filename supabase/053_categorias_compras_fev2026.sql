...
VALUES
  ...
  ('ALIMENTACAO_CANTEIRO', 'Alimentacao', 'Aline', 'Welton', 3000, '{"ate_500":3,"501_a_2k":3,"acima_2k":3}', '3 cotacoes. Recorrentes: 5 referencias. Fornecedor unico preferencial. Alvara sanitario obrigatorio e contrato pelo periodo da obra.', '#f97316', 'Utensils', ARRAY['alimentacao','restaurante','padaria','marmita','almoco','jantar','cafe'], true),
  ('ITENS_ALOJAMENTO', 'Itens de Alojamento', 'Aline', 'Welton', 3000, '{"ate_500":2,"501_a_2k":2,"acima_2k":2}', '2 cotacoes para manutencao. Solicitacao com relatorio fotografico do prefeito ou almoxarife.', '#059669', 'Home', ARRAY['alojamento','movel','eletrodomestico','colchao','cama','geladeira','conforto'], true),
  ...
  ('LOCACAO_IMOVEIS', 'Locacao de Imoveis', 'Aline', 'Laucidio', 0, '{"ate_500":5,"501_a_2k":5,"acima_2k":5}', '5 cotacoes minimas. Equipe de mobilizacao busca e vistoria com relatorio fotografico. Contratacao somente com aprovacao do Laucidio.', '#16a34a', 'Home', ARRAY['locacao','imovel','casa','apartamento','kitnet','aluguel','canteiro'], true),
  ...
  ('MANUT_FROTA', 'Manutencao Frotas e Maquinas', 'Fernando', 'Welton', 3000, '{"ate_500":2,"501_a_2k":2,"acima_2k":2}', '2 cotacoes para manutencao. Oficinas revisadas a cada 3 meses. Preventiva por calendario e corretiva com relatorio fotografico.', '#f59e0b', 'Car', ARRAY['frota','maquina','manutencao','oficina','motorista','km','horimetro'], true),
  ...
  ('SERV_ADMIN', 'Servicos Administrativos', 'Leandro', 'Leandro', 3000, '{"ate_500":2,"501_a_2k":2,"acima_2k":2}', '2 cotacoes. Manutencao predial e demandas administrativas com relatorio fotografico e preferencia por fornecedores cadastrados.', '#64748b', 'Briefcase', ARRAY['administrativo','predial','jardinagem','dedetizacao','limpeza caixa dagua','moveis'], true),
