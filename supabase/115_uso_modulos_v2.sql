-- 115_uso_modulos_v2.sql
-- v2 da RPC do painel "Uso dos Módulos" (aplicada em produção via MCP em 2026-07-22):
--   + comparação com o período anterior (acessos_prev/acoes_prev/usuarios_prev no resumo)
--   + usuarios_por_dia (usuários únicos/dia, zero-fill)
--   + por_hora (atividade por hora do dia 0-23, fuso America/Sao_Paulo)
--   + dias_ativos por usuário
-- Tabela sys_acessos e RLS: ver 114_sys_acessos_uso_modulos.sql.
