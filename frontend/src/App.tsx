...
const EquipeObras = lazy(() => import('./pages/obras/EquipeObras'))
const GestaoObras = lazy(() => import('./pages/obras/GestaoObras'))
...
const RHColaboradores = lazy(() => import('./pages/rh/RHColaboradoresHome'))
        ...
        <Route element={<PrivateRoute />}>
          ...
          <Route element={<ModuleRoute moduleKey="obras" />}>
            <Route element={<ObrasLayout />}>
              ...
              <Route path="/obras/equipe"            element={<Lazy><EquipeObras /></Lazy>} />
              <Route path="/obras/gestao"            element={<Lazy><GestaoObras /></Lazy>} />
          ...
          {/* RC do solicitante — acessível via atalho "Minhas Solicitações"
              mesmo sem o módulo Compras (RLS no banco continua sendo a trava). */}
