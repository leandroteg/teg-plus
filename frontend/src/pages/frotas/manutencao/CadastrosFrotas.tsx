...
export default function CadastrosFrotas() {
  ...
  // Entra na mesma linha de título/filtros da tela, pelo slot `extra`, em vez
  // de gastar uma faixa só para ele.
  const alternador = (
  ...
  return (
    <div className="pb-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-5">
        {vista === 'fornecedores'
          ? <FornecedoresCad segmentos={SEGMENTOS_FROTA} titulo="Fornecedores de Frotas" extra={alternador} />
          : <ItensCad subcategorias={SUBCATEGORIAS_FROTA} titulo="Itens de Frotas" extra={alternador} />}
      </div>
    </div>
  )
}
