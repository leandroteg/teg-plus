...
import {
  ...
  FileWarning, ShieldAlert, ChevronDown, Settings2,
} from 'lucide-react'
...
export default function FrotasHome({ initialPainel }: { initialPainel?: 'painel' | 'disponibilidade' | 'indicadores' | 'motoristas' } = {}) {
  ...
  const statusSegments = useMemo(() => {
    ...
    return [
      ...
      { key: 'parada_manutencao', label: 'Parada p/ Manutenção', value: counts.parada_manutencao ?? 0, barClass: 'bg-rose-600' },
      { key: 'necessario_parada', label: 'Necessário Parada',   value: counts.necessario_parada ?? 0, barClass: 'bg-orange-500' },
