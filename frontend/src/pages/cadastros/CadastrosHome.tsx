...
import {
  Building2, Package2, Tag, Target, HardHat, Users,
  Plus, Sparkles, ArrowRight,
} from 'lucide-react'
import { useCadFornecedores, useCadClasses, useCadCentrosCusto, useCadObras, useCadColaboradores } from '../../hooks/useCadastros'
