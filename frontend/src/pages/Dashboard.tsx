...
const PIPELINE_ETAPAS = [
  { key: 'pendentes',  label: 'Pendentes',   statuses: ['rascunho', 'aguardando_catalogo', 'pendente'] as StatusRequisicao[],   color: 'text-amber-600',   bg: 'bg-amber-50',   border: 'border-amber-200',   barClass: 'bg-amber-400'   },
  { key: 'triagem_cd', label: 'Sala Téc. / CD', statuses: ['em_analise_tecnica', 'em_triagem_cd'] as StatusRequisicao[],       color: 'text-sky-600',     bg: 'bg-sky-50',     border: 'border-sky-200',     barClass: 'bg-sky-500'     },
...
const STATUS_ATIVO: StatusRequisicao[] = [
  'rascunho', 'aguardando_catalogo', 'em_analise_tecnica', 'em_triagem_cd', 'pendente', 'em_aprovacao', 'aprovada', 'em_esclarecimento',
