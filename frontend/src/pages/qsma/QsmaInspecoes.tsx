...
import { ExecutarInspecaoModal, InspecaoAlojamentoFluxo } from '../../components/qsma/InspecaoAlojamento'
import {
...
export default function QsmaInspecoes() {
  ...
  return (
    ...
    >
      ...
      {modalAloj && (
        <InspecaoAlojamentoFluxo isDark={isDark} onClose={() => setModalAloj(false)} />
      )}
      {executar && (
