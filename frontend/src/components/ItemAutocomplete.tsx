...
const CATEGORY_MAP: Record<string, string[]> = {
  ...
  OUTROS_MAT_OBRA: ['Material ElÃ©trico', 'Almoxarifado Geral'],
  ...
  LOCACAO_IMOVEIS: [],
  SERV_OBRA_LOG:   [],
  MAT_ESCRITORIO_CD: ['Material de EscritÃ³rio'],
  MANUT_FROTA:     ['Ferramental', 'Almoxarifado Geral'],
  AQUISICAO_ATIVOS: [],
  SERV_ADMIN:      ['Material de EscritÃ³rio', 'Almoxarifado Geral'],
  SOFTWARE_HARDWARE_TI: ['Material de EscritÃ³rio'],
  MAT_ESCRITORIO_SEDE: ['Material de EscritÃ³rio'],
  COMPRAS_EXTRA:   ['Material ElÃ©trico', 'Almoxarifado Geral', 'EPI/EPC', 'Ferramental', 'Material de EscritÃ³rio'],
