...
const SELECT_COTACAO = `
  ...
  requisicao:cmp_requisicoes(
    ...
    compra_recorrente, arquivo_url,
    itens:cmp_requisicao_itens(id, descricao, descricao_complementar, quantidade, unidade, valor_unitario_estimado, marca, atendido_em_pedido_id)
  ),
